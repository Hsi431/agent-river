...
<body${view === "mail" ? ' class="postal-page"' : ""}${autoRefresh}><div class="shell"><aside class="sidebar"><a class="brand" href="/mail"><svg class="brand-mark" viewBox="0 0 32 40" fill="none" aria-hidden="true"><path d="M7 3c20 8-16 19 4 34M16 3c20 8-16 19 4 34M25 3c20 8-16 19 4 34" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg><b>Agent River</b></a>
